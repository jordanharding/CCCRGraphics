...
<script>
    ...
    $(document).ready(function () {
        ...
        var chartadata = $.get(window.location.origin + '/csvs/4.15a.csv', function (data) {
            ...
            $.each(lines, function (lineNo, line) {
                ...
                if (lineNo === 0) {
                    ...
                    // if (!isNaN(one) && !isNaN(two) && !isNaN(three)) {
                        ...
                        optionsa.series[0].color = '#026800';
        ...
        var chartbdata = $.get(window.location.origin + '/csvs/4.15b.csv', function (data) {
            var lines = data.split('\n');
            ...
            $.each(lines, function (lineNo, line) {
                ...
                if (lineNo === 0) {
                    ...
                    optionsb.series[0].color = '#026800';
